...
// Deprecated: 请改用 User.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 LoginRequest.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 LoginResponse.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 RefreshTokenRequest.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 RefreshTokenResponse.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 ChangePasswordRequest.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 ChangePasswordResponse.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 CreateUserRequest.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 CreateUserResponse.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 UpdateUserRequest.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 UpdateUserResponse.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 DeleteUserRequest.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 DeleteUserResponse.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 GetUserRequest.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 GetUserResponse.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 ListUserRequest.ProtoReflect.Descriptor。
...
// Deprecated: 请改用 ListUserResponse.ProtoReflect.Descriptor。
...
const file_apiserver_v1_user_proto_rawDesc = "" +
	...
	"totalCount\x12(\n" +
	"\x05users\x18\x02 \x03(\v2\x12.apiserver.v1.UserR\x05usersB8Z6github.com/clin211/linhub/api/apiserver/v1;v1b\x06proto3"
...
var file_apiserver_v1_user_proto_depIdxs = []int32{
	...
	6,  // [6:6] 是方法 output_type 的子列表
	6,  // [6:6] 是方法 input_type 的子列表
	6,  // [6:6] 是扩展 type_name 的子列表
	6,  // [6:6] 是扩展 extendee 的子列表
	0,  // [0:6] 是字段 type_name 的子列表
}
