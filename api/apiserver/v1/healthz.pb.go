...
// Deprecated: 请改用 ServiceStatus.Descriptor。
...
// Deprecated: 请改用 HealthzResponse.ProtoReflect.Descriptor。
...
const file_apiserver_v1_healthz_proto_rawDesc = "" +
	...
	"\tUnhealthy\x10\x01B8Z6github.com/clin211/linhub/api/apiserver/v1;v1b\x06proto3"
...
var file_apiserver_v1_healthz_proto_depIdxs = []int32{
	...
	1, // [1:1] 是方法 output_type 的子列表
	1, // [1:1] 是方法 input_type 的子列表
	1, // [1:1] 是扩展 type_name 的子列表
	1, // [1:1] 是扩展 extendee 的子列表
